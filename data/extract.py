...
if __name__== "__main__":
    if len(sys.argv) != 2:
        print("Usage: python extract.py [Dames2020 dataset]")
        print("The Dames2020 dataset (data.csv) can be obtained from OSF under 'osf.io/x3wvf'")
        exit()
    
    # Load the raw data
    raw_df = pd.read_csv(sys.argv[1], delimiter=';')
